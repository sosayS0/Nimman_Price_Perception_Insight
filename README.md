...
* **Phase 1: Data Engineering (Completed) 🟢** * Developed a Python web scraping script to extract and clean 5,000+ customer reviews from Google Maps and Tripadvisor. *(Code available in this repository).*
